...
class MobileFaceNetEncoder(context: Context) {
    ...
    fun getFaceEmbedding(bitmap: Bitmap): FloatArray {
        // Defensive: automatically scale the bitmap if it is not 112x112
        ...
        // Recycle the temporary bitmap if we created a scaled copy to save memory
    ...
    // Helper function to normalize embedding to unit length
